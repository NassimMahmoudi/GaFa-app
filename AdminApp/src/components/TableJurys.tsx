  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="py-6 px-4 md:px-6 xl:px-7.5">
        ...
        <div className="p-4 md:p-6 xl:p-9 " style={myStyle}>
            <Link
              to="/addjury"
      ...
      <div className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
        <div className="col-span-3 flex items-center">
          <p className="font-medium">Jury email</p>
        </div>
      ...
      <div className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
        ...
        <div className="flex items-center space-x-3.5">
          <Link to='/jury' className="hover:text-primary">
                    <svg
                  ...
                  <Link to='#' onClick={() => { if (window.confirm('Are you sure you want to Delete this jury?'))"fff"}} className="hover:text-primary">
          <svg
                      className="fill-current"
                      width="18"
                      height="18"
