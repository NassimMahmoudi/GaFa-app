      ...
      <div className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
        ...
        <div className="flex items-center space-x-3.5">
          <button className="hover:text-primary">
                  ...
                  <Link to='#' onClick={() => { if (window.confirm('Are you sure you want to Delete this user?'))"fff"}} className="hover:text-primary">
          <svg
                      className="fill-current"
                      width="18"
                      height="18"
                  ...
                  <Link to='#' onClick={() => { if (window.confirm('Are you sure you want to Block this user?'))"fff"}} className="hover:text-primary">
          <svg
                      className="fill-current"
                      width="18"
                      height="18"
