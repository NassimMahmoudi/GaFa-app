...
const SignIn = () => {
  ...
  return (
    <div>
      ...
      <div  className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark" style={myStyle}>
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              Welcome to our official homepage of the Ministry of Culture. Explore our diverse content and learn about our unique cultural objectives and events.
              </p>
            ...
            <div className="w-full">
              ...
              <ul>
                <li className="leading-relaxed text-[#CD5D5D]">
                  Email Or Password may be wrong please try again or contact GaFa Admin
                </li>
              </ul>
            </div>
          </div>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/auth/signin" className="text-primary">
                      To Sign Up Please Contact GaFa App Admin
                    </Link>
                  </p>
                </div>
              </form>
